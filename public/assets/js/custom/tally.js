$(document).ready(function () {
    ...
    var tbl_denum = $('#tbl_denum').DataTable({
        ...
        drawCallback: function () {
            ...
            var ess = (arr[0].EServices > 0) ? parseFloat(arr[0].EServices).toLocaleString(undefined, {
                minimumFractionDigits: 2,
                maximumFractionDigits: 2
            }) : '-';
            ...
            var eservices = (arr[0].EServices > 0) ? parseFloat(arr[0].EServices) : 0;




            var tcs = totamt - ((lcf > 0) ? lcf : 0)
            var pos = tcs - ((eservices > 0) ? eservices : 0)
            ...
            $('#ps', api.table().footer()).html(pos.toLocaleString(undefined, {
                minimumFractionDigits: 2,
                maximumFractionDigits: 2
            })).addClass('text-right');
            $('#es', api.table().footer()).html(ess.toLocaleString(undefined, {
                minimumFractionDigits: 2,
                maximumFractionDigits: 2
            })).addClass('text-right');
