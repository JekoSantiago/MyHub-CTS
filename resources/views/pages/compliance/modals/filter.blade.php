<div id="modal_filter_comp" class="modal fade" data-backdrop="static" tabindex="-1" role="dialog" aria-hidden="true">
                ...
                <form id="form_filter_cts">
                    ...
                    <div class="form-group">
                        <div class="row">
                            <div class="col">
                                ...
                                <input type="date" id="filter_dateFrom" name="filter_dateFrom" class="form-control flatpickr" value="{{date('Y-m-d', strtotime('-7 days'))}}">
                    ...
                    <div class="text-center">
                        <div>
                            ...
                            <button type="button" id="btn_filter_comp" class="btn btn-primary waves-effect waves-light">Apply</button>
                        </div>
                    </div>
                </form>
            </div>
